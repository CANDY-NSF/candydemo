...
int main(int argc, char *argv[]) {
  ...
  if (argc < 2) {
    cout << "INPUT ERROR:: Three inputs required. First: filename. Second: "
            "number of changed edges. Third: Percentage of Inserted Edges (in "
            "values 0 to 100) \n";
    return 0;
  }
  ...
  if (!the_file.is_open()) {
    cout << "INPUT ERROR:: Could not open main file\n";
  }
